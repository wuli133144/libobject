...
struct inet_tcp_client_s{
    ...
    int (*connect_async)(Inet_Tcp_Client *socket, char *host, char *service);

    ssize_t (*send)(Inet_Tcp_Client *client, const void *buf, size_t len, int flags);
    ssize_t (*recv)(Inet_Tcp_Client *client, const void *buf, size_t len, int flags);

    socket_status_t (*send_async)(Inet_Tcp_Client *client, const void *buf, size_t *len, int flags);
    socket_status_t (*recv_async)(Inet_Tcp_Client *client, const void *buf, size_t *len, int flags);
