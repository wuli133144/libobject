...
#define CONFIG_ARGSNIC	     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_DBG_ARGSNIC 
#define CONFIG_FATAL	     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_FATAL 
#define CONFIG_ERROR	     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_ERROR 
#define CONFIG_WARNNING	     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_WARNNING 
#define CONFIG_SUC		     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_SUC 
#define CONFIG_CORRECT	     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_CORRECT 
#define CONFIG_VIP 		     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_VIP 
#define CONFIG_FLOW		     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_FLOW 
#define CONFIG_IMPORTANT	 DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_IMPORTANT 
#define CONFIG_DETAIL	     DBG_BUSINESS_CONFIG_INTERFACE	<< 8 | DBG_DETAIL 
#endif
